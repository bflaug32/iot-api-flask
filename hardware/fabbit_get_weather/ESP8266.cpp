...
int ESP8266::httpGet()
{
  char* request =  "GET /api/v1/gettemp HTTP/1.1\r\nHost: bradflaugher.com\r\nConnection: close\r\n\r\n";

  if (createTCP("bradflaugher.com", 80))
  {
...
int ESP8266::httpGet(char* SERVER, char* RESOURCE, int portNum)
{
  //char* request =  "GET /api/v1/gettemp HTTP/1.1\r\nHost: bradflaugher.com\r\nConnection: close\r\n\r\n";
